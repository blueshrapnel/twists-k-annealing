...
The pilot's identity claim survives at scale, and more strongly.
Comparing each scale lineage's stage-one final against its tail run-best:
the dominant label is unchanged and its largest basin is cell-for-cell
identical (basin Jaccard $1.000$) in all six lineages, with coverage
unchanged to three decimals and $95$--$100\%$ of $\sigma$ rows
byte-identical; the attractor cycle is identical in five of six (in one
$13 \times 13$ lineage the cycle shifted within the same, unchanged
basin).  At scale the tail buys its fitness gain without moving the
attractor footprint at all: consolidation in the purest sense.
